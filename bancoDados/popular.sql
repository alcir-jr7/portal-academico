...
-- Inserindo usuários (alunos, professores, administrador)
INSERT INTO usuarios (nome, matricula, senha, tipo, ativo) VALUES
('João Silva', 'ALN1', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'aluno', TRUE),
('Maria Souza', 'ALN2', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'aluno', TRUE),
('Allan Lima', 'PROF1', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'professor', TRUE),
('Emaur Florêncio', 'PROF2', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'professor', TRUE),
('Hugo Dantas', 'PROF3', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'professor', TRUE),
('Nami', 'ADM1', '$2y$10$yzg7okswAFGkLSrVhpDcaebEWHvUkHDbvKaXXPCx4J9VsXF52zgvG', 'admin', TRUE);

-- Inserindo professores (id deve ser o mesmo do usuário correspondente)
...
-- Inserindo alunos (id do aluno = id do usuário correspondente)
...
(1, 3, '2025.1', 'Seg e Qua 08:00-10:00'), -- Allan - Lógica
(4, 5, '2025.1', 'Ter e Qui 19:00-21:00'), -- Hugo - Cálculo
(2, 4, '2025.1', 'Qua e Sex 14:00-16:00'); -- Emaur - Projeto I

-- Inserindo matrículas dos alunos nas turmas
...
-- Inserindo matrículas acadêmicas
